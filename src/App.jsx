  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#020617] text-white font-sans">
      ...
      <header className="p-6 border-b border-slate-800 flex justify-between items-center bg-slate-900/50 backdrop-blur-md sticky top-0 z-50">
        ...
        <div>
          {/* Show Sign In button if Guest, User Profile if Signed In */}
          <SignedOut>
            <SignInButton mode="modal" className="bg-slate-800 hover:bg-slate-700 px-5 py-2 rounded-xl font-bold text-[10px] uppercase tracking-widest text-white transition border border-slate-700">
              Sign In
            </SignInButton>
          </SignedOut>
          <SignedIn>
