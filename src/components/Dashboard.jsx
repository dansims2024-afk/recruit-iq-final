...
// Ensure logo.png is in your 'src' folder
...
export default function Dashboard() {
  ...
  return (
    <div className="relative p-6 md:p-10 max-w-7xl mx-auto space-y-8 text-white bg-[#0B1120] min-h-screen pt-20">
      ...
      {/* SALES MODAL (RESTORING HIGH-LEVEL VERSION WITH REDIRECT FIX) */}
      {showLimitModal && (
              ...
              <div className="p-10 md:w-3/5 flex flex-col justify-center relative z-10 text-left">
                 ...
                 {!isSignedIn ? (
                    <SignUpButton 
                      ...
                      signInForceRedirectUrl="/upgrade"
                    >
      ...
      {showSupportModal && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 backdrop-blur-xl bg-slate-950/80">
          <div className="bg-[#0F172A] border border-slate-700 p-10 rounded-[2.5rem] max-w-lg w-full shadow-2xl text-center text-left">
