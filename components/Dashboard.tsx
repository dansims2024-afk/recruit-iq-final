...
export default function Dashboard() {
  ...
  // FAIL-SAFE REDIRECT: Direct link bypasses all modal click conflicts
  const handleStartTrial = () => {
    sessionStorage.setItem('pending_stripe', 'true');
    window.location.href = `https://accounts.recruit-iq.com/sign-up?redirect_url=${encodeURIComponent(window.location.origin + '/?signup=true')}`;
  };
